...
<head>
    ...
    <title>datasheet.md (editing)</title>
...
data-base-url="/"
data-file-path="data/datasheet.md"
    ...
    if (window.parent !== window) {
      require(['base/js/namespace'],function(Jupyter){
        ...
        window.addEventListener('message', function(event) {
          if (Jupyter.notebook && event.data.fromCourseraWeb && event.data.courseraCommand === 'coursera:save') {
